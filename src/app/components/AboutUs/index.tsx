    ...
    <div className="flex flex-col gap-8 lg:flex-row lg:justify-between px-6 lg:px-16 pt-[56px] lg:pt-[96px] lg:relative">
      ...
      <div className="flex flex-col gap-4 lg:gap-8 lg:max-w-[850px]">
        ...
        <p className="text-lg lg:text-xl text-[#0C1E21]">
          ...
          документація. Тому із часом гори паперу потрібно кудись подіти, а
          найкращий варіант - архівувати.
        </p>
        <p className="lg:text-lg text-[rgba(6,39,44,0.60)]">
          ФОП Гупало Петро Євгенович надає повний комплекс архівних послуг у
          Львівській області. Здійснить як експертну оцінку документів,
          оптимізує документообіг, так і виконає палітурні роботи різної
          складності.
        </p>
        <p className="lg:text-lg text-[rgba(6,39,44,0.60)]">
