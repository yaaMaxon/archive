    ...
    >
      ...
      <div className="flex flex-col gap-4 lg:gap-8 lg:max-w-[850px]">
        ...
        <p className="text-[#0C1E21]">
          ...
          завдань з вказанням термінів зберігання цих справ. Це визначення
          відноситься до номенклатури справ конкретного підприємства. Проте
          ускладнення сучасного державного і господарського життя, структури
          ...
          класифікації документних комплексів, що утворюються в результаті їх
          діяльності.
          <br />
          <br />
          Номенклатура справ – це систематизований перелік заголовків справ,
          певних видів документів, що утворюються в діловодстві, з однорідними
          функціями і однотипним складом, що утворюються в їх діяльності.
        </p>
      </div>
    </div>
  );
