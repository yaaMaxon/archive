import processingDocument from "@assets/img/ProcessingDocument.webp";
import expertDocuments from "@assets/img/ExpertDocuments.webp";
import reductionDocuments from "@assets/img/ReductionOfDocuments.webp";
import bookbindingWork from "@assets/img/BookbindingWork.webp";
import optimizationDocuments from "@assets/img/OptimizationDocument.webp";

export const archivServicesList = [
  {
    image: processingDocument,
    title: "Архівна обробка документів",
  ...
  },
  {
    ...
    title: "Експертна оцінка документів",
    price: "Під замовлення",
    description:
  ...
  },
  {
    ...
    title: "Конфіденційне знищення документів",
    price: "Під замовлення",
    description:
  ...
  },
  {
    ...
    title: "Оптимізація документообігу на підприємстві",
    price: "Під замовлення",
    description:
